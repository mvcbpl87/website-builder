...
import { AreaChart, Contact2, DollarSign, ShoppingCart } from 'lucide-react'
...
export default function Page({params}:Props){
    ...
    let closingRate = 0
    let funnelPerformanceMetrics:any = []
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <Card className="p-4 flex-1">
             ...
             <div className='w-full text-center text-muted-foreground/50'>No data.</div>
              {/* <AreaChart
